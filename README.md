[![Build Status](https://travis-ci.org/datenverteiler/de.bsvrz.sys.funclib.debug.svg?branch=develop)](https://travis-ci.org/datenverteiler/de.bsvrz.sys.funclib.debug)
